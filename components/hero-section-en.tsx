                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <h1 
                                    ...
                                    <span style={{ color: '#E19BFF' }}>AI Assistant</span>
                                    <span style={{ color: '#00251D' }}> that responds in seconds and schedules appointments automatically</span>
                                </h1>
                                <p className="mx-auto mt-8 max-w-2xl text-balance text-base sm:text-lg px-4 sm:px-0" 
                                    ...
                                    Developers and real estate companies that have integrated our solution have increased their sales <strong>up to 35%</strong>
                                </p>
