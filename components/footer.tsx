...
export default function FooterSection({ locale = 'es' }: { locale?: string }) {
        ...
        <footer className="py-8 md:py-12" style={{ backgroundColor: '#F2F4F8' }}>
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="my-6 flex flex-wrap justify-center gap-4 text-sm">
                    <Link
                        href="https://co.linkedin.com/company/la-haus"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="LinkedIn"
                        className="hover:text-primary block" style={{ color: '#00251D' }}>
                        <svg
                            className="size-6"
                    ...
                    <Link
                        href="https://www.facebook.com/LaHausMX"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="Facebook"
                        className="hover:text-primary block" style={{ color: '#00251D' }}>
                    ...
                    <Link
                        href="https://www.instagram.com/lahausmex/?hl=es"
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    <Link
                        href="https://www.youtube.com/@LaHaus/featured"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="YouTube"
                        className="hover:text-primary block" style={{ color: '#00251D' }}>
                    ...
                    <Link
                        href="https://www.tiktok.com/@lahausmx"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="TikTok"
                        className="hover:text-primary block" style={{ color: '#00251D' }}>
