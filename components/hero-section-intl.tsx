...
import { Header } from '@/components/header-intl'
import StatsSection from '@/components/stats-intl'
import FeaturesSection from '@/components/features-intl'
import IntegrationsSection from '@/components/integrations-intl'
import CallToAction from '@/components/call-to-action-intl'
import FAQsTwo from '@/components/faqs-intl'
import { WhatsAppButton } from '@/components/whatsapp-button-intl'
import FooterSection from '@/components/footer-intl'
...
export function HeroSection({ locale }: HeroSectionProps) {
    ...
    return (
        <>
            <Header locale={locale} onBookDemo={() => setIsBookingModalOpen(true)} />
            ...
            <main className="overflow-hidden">
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <h1 
                                    ...
                                    <span style={{ color: '#E19BFF' }}>{t.hero.title1}</span>
                                    <span style={{ color: '#00251D' }}>{t.hero.title2}</span>
                                </h1>
                ...
                <CallToAction locale={locale} onBookDemo={() => setIsBookingModalOpen(true)} />
