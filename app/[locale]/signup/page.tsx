...
export default async function SignUpPage({ params }: Props) {
  ...
  return (
    <section className="flex min-h-screen bg-gradient-to-br from-primary-50 to-white px-4 py-16 md:py-32">
      <form
        action=""
        className="bg-muted m-auto h-fit w-full max-w-sm overflow-hidden rounded-[calc(var(--radius)+.125rem)] border shadow-2xl dark:[--color-muted:var(--color-zinc-900)]">
